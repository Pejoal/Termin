...
<template>
  <GuestLayout>
    <Head :title="$page.props.words.login" />
    <section class="p-8 my-4 bg-zinc-800 w-full rounded-lg md:container">
      ...
      >
        ...
        >
          ...
          {{ $page.props.words.sign_in_with_github }}
        </a>
        <a
        ...
        >
          ...
          {{ $page.props.words.sign_in_with_google }}
        </a>
      </section>
      <Link
        :href="route('register')"
