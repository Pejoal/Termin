...
const _sfc_main = {
  ...
  setup(__props, { emit: emits }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      } else if (["super admin", "admin"].includes(_ctx.$page.props.auth.user.type)) {
      ...
      _push(`<button type="button" class="btn btn-danger">${ssrInterpolate(_ctx.trans("words.delete_appointment"))}</button></footer></form></main>`);
    };
  }
};
