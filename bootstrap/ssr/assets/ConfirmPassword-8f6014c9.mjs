      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><div class="flex justify-end mt-4"${_scopeId}><button class="${ssrRenderClass([{ "opacity-25": unref(form).processing }, "ml-4 btn btn-success"])}"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""}${_scopeId}>${ssrInterpolate(_ctx.$page.props.words.confirm)}</button></div></form>`);
          } else {
            return [
              ...
              createVNode("form", {
                ...
                createVNode("div", { class: "flex justify-end mt-4" }, [
                  ...
                  }, toDisplayString(_ctx.$page.props.words.confirm), 11, ["disabled"])
                ])
              ], 40, ["onSubmit"])
            ];
          }
