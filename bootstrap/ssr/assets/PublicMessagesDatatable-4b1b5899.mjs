...
const PublicMessagesDatatable_vue_vue_type_style_index_0_lang = "";
const _sfc_main = {
  __name: "PublicMessagesDatatable",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Dashboard/PublicMessagesDatatable.vue");
