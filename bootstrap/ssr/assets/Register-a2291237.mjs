      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<form class="bg-zinc-300 w-full mt-2 mb-4 rounded-lg md:container px-8 py-4 flex flex-col gap-2"${_scopeId}><div${_scopeId}>`);
            ...
            _push2(ssrRenderComponent(_sfc_main$2, {
              for: "password",
              value: _ctx.trans("words.passwort")
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_sfc_main$3, {
              id: "password",
              type: "password",
              ...
              placeholder: _ctx.trans("words.passwort"),
              required: "",
            ...
            _push2(`<button class="${ssrRenderClass([{ "opacity-25": unref(form).processing }, "ml-4 btn btn-primary"])}"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""}${_scopeId}>${ssrInterpolate(_ctx.trans("words.login"))}</button></div></form>`);
          } else {
            return [
